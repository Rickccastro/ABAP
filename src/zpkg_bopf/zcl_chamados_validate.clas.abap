class ZCL_CHAMADOS_VALIDATE definition
  public
...
CLASS ZCL_CHAMADOS_VALIDATE IMPLEMENTATION.


  method /BOBF/IF_FRW_VALIDATION~EXECUTE.
  CLEAR: eo_message, et_failed_key.

  DATA: lt_data    TYPE ztddchamados, ls_message TYPE symsg.
  ...
  io_read->retrieve(
    EXPORTING
      ...
      it_requested_attributes = VALUE #( ( ZIF_DD_CHAMADOS_C=>sc_node_attribute-zdd_chamados-assunto ) )
    IMPORTING
      et_data                 = lt_data
  ).
