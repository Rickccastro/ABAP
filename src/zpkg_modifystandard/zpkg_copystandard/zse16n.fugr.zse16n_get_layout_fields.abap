FUNCTION ZSE16N_GET_LAYOUT_FIELDS.
*"--------------------------------------------------------------------
*"*"Interface local:
*"  IMPORTING
...
*.........do not consider client
          read table et_fieldcat into es_fieldcat
               with key fieldname = es_filter-fieldname.
          if es_fieldcat-datatype <> 'CLNT'.
...
*.........do not consider client
          read table et_fieldcat into es_fieldcat
               with key fieldname = es_sort-fieldname.
          if es_fieldcat-datatype <> 'CLNT'.
