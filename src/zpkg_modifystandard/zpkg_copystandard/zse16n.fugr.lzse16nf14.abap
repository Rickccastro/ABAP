...
*.fields that need to be in <all_table>
  ...
  data: ld_all_lines    like sy-tabix.
  data: ld_index_txt(20).
  data: ld_all_txt(20).
  data: ld_progress_text(45).
  field-symbols: <l_wa>,
...
*.....normal generation of pointers
  ...
  describe table <all_table> lines ld_all_lines.
  write ld_all_lines to ld_all_txt LEFT-JUSTIFIED.
...
*.....send progress every 100 lines and avoid time out
      if sy-batch is initial.
        if wa_index mod 100 = 0.
          write wa_index to ld_index_txt LEFT-JUSTIFIED.
          CONCATENATE ls_add-add_tab ':' ld_index_txt '/' ld_all_txt
             INTO ld_progress_text.
          CALL FUNCTION 'SAPGUI_PROGRESS_INDICATOR'
            EXPORTING
              TEXT  = ld_progress_text.
