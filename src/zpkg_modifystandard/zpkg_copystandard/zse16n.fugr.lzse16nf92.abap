...
FORM CREATE_SELFIELDS  TABLES IT_SELTAB           structure se16n_seltab
                              ...
                              IT_PARAMETER_FIELDS STRUCTURE SE16N_SELTAB
                       USING  value(p_tab)
...
*...enhance layout fields
    ...
    when c_ext_top_of_page.
       if sy-batch <> true.
*........always delete to allow refresh of top-of-page durign navigation
         if not gd-ext_top_dock is initial.
            call method gd-ext_top_dock->free.
            clear gd-ext_top_dock.
         endif.
