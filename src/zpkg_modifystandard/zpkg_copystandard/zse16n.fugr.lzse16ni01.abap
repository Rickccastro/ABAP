...
*..check that TIMS-field does not contain 24:00:00
   if gs_multi_select-datatype = 'TIMS' OR
      gs_multi_select-datatype = 'TIMN'.
      if gs_multi_select-low = '240000'.
         gs_multi_select-low = '000000'.
         message i333(wusl).
      elseif gs_multi_select-high = '240000'.
         gs_multi_select-high = '235959'.
         message i333(wusl).
      else.
      endif.
   endif.
