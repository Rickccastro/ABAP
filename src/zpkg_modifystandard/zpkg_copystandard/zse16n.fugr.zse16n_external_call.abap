...
*"     VALUE(I_NO_CONVEXIT) TYPE  CHAR1 DEFAULT SPACE
*"     VALUE(I_CHECKKEY) TYPE  CHAR1 DEFAULT ' '
*"     VALUE(I_FORMULA_NAME) TYPE  GTB_FORMULA DEFAULT SPACE
*"  TABLES
...
*.it_or_selfields contains additional criteria for multi-or-select
  append lines of it_or_selfields to lt_or_selfields.
...
*..call SE16H finally
   CALL FUNCTION 'SE16N_INTERFACE'
          ...
          TABLES
            ...
            it_add_up_curr_fields = it_add_up_curr_fields
            it_add_up_quan_fields = it_add_up_quan_fields
            it_having_fields      = it_having_fields
            it_parameter_fields   = it_parameter_fields
         Exceptions
            no_values             = 1.
  if sy-subrc = 1.
