FUNCTION-POOL ZSE16N.                        "MESSAGE-ID ..
...
data: begin of gd,
        ...
        proxy_object TYPE viewname,  "proxy view for select
        proxy_text   TYPE ddtext,    "text of proxy object
        ...
        cursor_table(1),             "set cursor on table input upon start
        ...
        comprflag(1),                "COMPRFLAG from DD02L
        ...
        lzero      type LVC_LZERO,     " leading zero - note 3231981
      end of gd.

*.structure for global flags of table FIN_FLAGS
data: begin of gd_flags,
        se16n_no_conversion     type se16n_no_conversion,
        se16n_tooltip_business  type se16n_tooltip_business,
        se16n_dynamic_table_off type se16n_dynamic_table_off,
        se16n_cursor_on_table   type fin_flags_on_off,
        se16n_no_popup          type boolean,
      end of gd_flags.
...
controls: selfields_tc type tableview using screen 0100. " 3285573 enhancement
"controls: selfields_tc type tableview using screen 9100. "  3285573 enhancement
*controls: selfields_tc type tableview using screen 0101.     " 3285573 enhancement
...
data: gt_parameter_fields like se16n_seltab occurs 0 with header line.
...
data: g_dynnr       TYPE sy-dynnr.  " 3285573 enhancement

include lse16nsdt.

include fin_flags_constants.
